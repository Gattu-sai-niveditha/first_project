		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SecondProject",
									"targetURL": "#uiMyProjectTwosecondproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiMyProjectTwosecondproject-display": {
								"semanticObject": "uiMyProjectTwosecondproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.MyProjectTwo.secondproject",
									"url": sap.ui.require.toUrl("ui/MyProjectTwo/secondproject")
								}
							}
						}
					}
